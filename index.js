...
async function init() {
  try {
    ...
    createOutputFile('dates.txt', header_Dates);
    ...
    await importFile(`${repositoryPath}/${gtfsCommonFilesDirectoryName}/`, 'dates.txt', header_Dates);
    ...
    outputZip.addLocalFile(OUTPUT_DIRECTORY_PATH + 'dates.txt');
